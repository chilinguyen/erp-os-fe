import { Button, Input, Modal, SelectCustom } from '@/components'
    ...
    <>
      ...
      <Modal open={open} setOpen={handleClose} preventClose>
        ...
        <Input
          ...
          {...inputStylesPath({
            error: createResult?.error?.result.label && translate(createResult.error.result.label),
          })}
        />
        <SelectCustom<PathTypeEnum>
          ...
          buttonProps={{
            ...inputStylesPath({
              error: createResult?.error?.result.type && translate(createResult.error.result.type),
            }),
            width: '100%',
          }}
        />
